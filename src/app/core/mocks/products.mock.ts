...
const ProductMock: Product[] = [
  ...
  },
  {
    ...
    description:
      'Coche antiguo americano de color marron. Se tiene que cambiar el motor pero aparte de eso todo funciona correctamente. Interior de piel clara. Ideal para coleccionistas',
    price: '210000',
